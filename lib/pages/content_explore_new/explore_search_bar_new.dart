...
class ExploreSearchBarNew extends StatefulWidget {
  final TextEditingController controller;
  final ValueChanged<String> onChanged;

  final List<String> initialTime;
  final List<String> initialPrice;
  final Function(List<String>, List<String>, int) onFilterApply;
  final int selectedIndex;
  final Function(int)? onTypeChange;

  const ExploreSearchBarNew({
    super.key, 
...
class _ExploreSearchBarState extends State<ExploreSearchBarNew> {  
  ...
  @override
  void didUpdateWidget(covariant ExploreSearchBarNew oldWidget) {
            ...
            IconButton(
              onPressed: () async {
                ...
                if (result != null) {
                  ...
                  final type = (result['type'] as int?) ?? widget.selectedIndex;

                  widget.onFilterApply(paramTime, paramPrice, type);

                  if (result['type'] != null) {
                    widget.onTypeChange?.call(result['type']);
                  }
                }
              },
