...
class ExploreAllNew extends StatefulWidget {
  ...
  @override
  State<ExploreAllNew> createState() => _ExploreAllState();
}

class _ExploreAllState extends State<ExploreAllNew> {
  String? langCode;
  ...
  @override
  void didUpdateWidget(covariant ExploreAllNew oldWidget) {
