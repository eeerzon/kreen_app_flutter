...
class ExploreEventNew extends StatefulWidget {
  ...
  @override
  State<ExploreEventNew> createState() => _ExploreEventState();
}

class _ExploreEventState extends State<ExploreEventNew> {
  String? langCode;
  ...
  @override
  void didUpdateWidget(covariant ExploreEventNew oldWidget) {
