...
class ExploreVoteNew extends StatefulWidget {
  ...
  @override
  State<ExploreVoteNew> createState() => _ExploreVoteState();
}

class _ExploreVoteState extends State<ExploreVoteNew> {
  String? langCode;
  ...
  @override
  void didUpdateWidget(covariant ExploreVoteNew oldWidget) {
