...
class DeskripsiSection_3 extends StatefulWidget {
  final Map<String, dynamic> data;
  final List<dynamic> dataNotif;
  final String langCode;
  final String? currencyCode;
  const DeskripsiSection_3({super.key, required this.data, required this.dataNotif, required this.langCode, this.currencyCode});

  @override
    State<DeskripsiSection_3> createState() => _DeskripsiSection_3State();
  }

  class _DeskripsiSection_3State extends State<DeskripsiSection_3> {
...
class LeaderboardSection_3 extends StatefulWidget {
  ...
  @override
  State<LeaderboardSection_3> createState() => _LeaderboardSection_3State();
}

class _LeaderboardSection_3State extends State<LeaderboardSection_3> {
  // ignore: unused_field
  String _storedToken = '';
