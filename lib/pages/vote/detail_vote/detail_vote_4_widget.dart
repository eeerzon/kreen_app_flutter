...
class DeskripsiSection_4 extends StatefulWidget {
  final Map<String, dynamic> data;
  final List<dynamic> dataNotif;
  final String langCode;
  final String? currencyCode;
  const DeskripsiSection_4({super.key, required this.data, required this.dataNotif, required this.langCode, this.currencyCode});

  @override
    State<DeskripsiSection_4> createState() => _DeskripsiSection_4State();
  }

  class _DeskripsiSection_4State extends State<DeskripsiSection_4> {
...
class LeaderboardSection_4 extends StatefulWidget {
  final List<dynamic> ranking;
  final Map<String, dynamic> data;
  final String langCode;
  const LeaderboardSection_4({super.key, required this.ranking, required this.data, required this.langCode});

  @override
  State<LeaderboardSection_4> createState() => _LeaderboardSection_4State();
}

class _LeaderboardSection_4State extends State<LeaderboardSection_4> {
  // ignore: unused_field
  String _storedToken = '';
      ...
      children: [
        ...
        Column(
          ...
          ? support.map<Widget>((item) {
            ...
            var hideNama = item['hide_name']?.toString() ?? '0';
