...
class DeskripsiSection_2 extends StatefulWidget {
  ...
  const DeskripsiSection_2({super.key, required this.data, required this.dataNotif, required this.langCode, this.currencyCode});
...
class LeaderboardSection_2 extends StatefulWidget {
...
class _LeaderboardSection_2State extends State<LeaderboardSection_2> {
  // ignore: unused_field
  String _storedToken = '';
