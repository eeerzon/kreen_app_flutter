...
class DeskripsiSection_5 extends StatefulWidget {
  ...
  const DeskripsiSection_5({super.key, required this.data, required this.langCode, this.currencyCode});

  @override
    State<DeskripsiSection_5> createState() => _DeskripsiSection_5State();
  }

  class _DeskripsiSection_5State extends State<DeskripsiSection_5> {
